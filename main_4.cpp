...
int main() {
   ...
   // Still didn't finish confirmation to save Guesses, ccode just saves automatically
    ...
    if (playerFile.is_open()) {
        ...
        playerFile.close();
        cout << "Player guess history saved to PlayerGuess.txt\n";
    } else {
        cout << "Unable to open PlayerGuess.txt for writing.\n";
    }
	...
	if (aiFile.is_open()) {	
	    ...
	    aiFile.close();
	    cout << "AI guess history saved to AIGuess.txt\n";
	} else {
	    cout << "Unable to open AIGuess.txt for writing.\n";
	}
